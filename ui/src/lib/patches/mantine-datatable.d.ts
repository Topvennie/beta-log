import { CollapseProps, MantineColor, MantineTheme } from "@mantine/core";
...
declare module "mantine-datatable" {
  ...
  export interface DataTableProps<T> {
    ...
    rowBackgroundColor?: (record: T, index: number) => MantineColor | undefined | { light: MantineColor; dark: MantineColor };
